...
const MOCK_DRAFTS = [
  {
    id: "0114",
    employer: "Continental Freightways",
  ...
  },
  {
    ...
    employer: "Continental Freightways",
    title: "Senior Backend Engineer",
    raw_text: "Used Splunk and Dynatrace for observability on the Northwind Logistics engagement.",
    suggested_text:
      "Implemented observability tooling (Splunk, Dynatrace) across the Northwind Logistics engagement to support production monitoring and incident triage.",
    confidence: "high",
    flagged_inferences: [],
